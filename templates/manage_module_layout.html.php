...
<head>
    ...
    <nav class="bg-blue-500 p-4">
        <ul class="flex space-x-4 justify-center">
            <li><a href="manage_module.php" class="text-white hover:text-gray-300"><i class="fas fa-list"></i> Module List</a></li>
            <li><a href="add_module.php" class="text-white hover:text-gray-300"><i class="fas fa-plus"></i> Add Module</a></li>
