    ...
    <div class="container mx-auto p-4">
        ...
        <input type="hidden" name="id" value="<?=$question['id']; ?>">
            <div class="mb-4">
                ...
                <textarea name="answertext" rows="2" cols="30" placeholder="Text" class="w-full px-3 py-2 text-gray-700 border rounded-lg focus:outline-none focus:shadow-outline" required></textarea>
            </div>
